...
public class Review1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("]");
        // prints values greater than average, ends if the current array slot is
        // unnasigned
    ...
    // the value of x is equal to the index of the first value in the pair and
    // length-(x+1) == the index of the secound value
