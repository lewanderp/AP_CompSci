...
//            System.out.println("Red=" + tmp.getRed() + " Blue=" + tmp.getBlue() + " Green=" + tmp.getGreen());
    ...
    public boolean getUp(){return upIsPressed;}
    public boolean getDown(){return downIsPressed;}
    public boolean getLeft(){return leftIsPressed;}
    public boolean getRight(){return rightIsPressed;}
